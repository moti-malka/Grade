...
public class taxbracket
{
   ...
   
   {
		...
		// close method Scanner
		inputfromuser.close();
        
		//call to method to Check Tax 
		CheckTax(salary, name);
   }  
   
	// method to Check How much tax the user has to pay 	
   ...
   // method to print tax salary and name of user
   public static void print(int salary, int tax, String moti)
	{
	   System.out.print("\nHello " + moti + " Your Salary is: " + salary + 
