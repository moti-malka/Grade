...
public class GradesCalculator {
	...
	public static void main(String[] args) {
		...
		System.out.println("the student number# " + Outstandingstudent + " got the highest grade and it's: " + topGrades + '\n');
		
		//print to user the low grade
		System.out.println("the student number# " + "" + studentfailed + " got the highest grade and it's: " + minGrades + '\n');
	}
}
